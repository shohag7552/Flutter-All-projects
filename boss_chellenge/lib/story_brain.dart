import 'package:boss_chellenge/story.dart';

int _count = 0;

class StoryBrain {
  List<Story> _storyText = [
    Story(
  ...
  String getStoryText() {
    return _storyText[_count].storyData;
  }

  String getFirstData() {
    return _storyText[_count].firstData;
  }

  String getSecondData() {
    return _storyText[_count].secondData;
  }
